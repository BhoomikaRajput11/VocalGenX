...
def test_speech():
    ...
    try:
        ...
        text = "As the first rays of sunlight pierced through the misty forest, a gentle breeze danced across the leaves, whispering secrets of the night to the waking world."
